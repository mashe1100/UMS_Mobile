...
public class LiquidReading {
    ...
    public static JSONObject UploadReadingAll(String JobID){
        try{
            JSONObject final_data_response = new JSONObject();
            JSONArray final_response = new JSONArray();
            JSONArray final_response_log = new JSONArray();
    ...
    public static JSONArray UploadReadingAll(String JobOrderId,String AccountNumber){
        JSONArray final_response = new JSONArray();
        Cursor result = ReadingModel.GetReadingDetailsAll(JobOrderId, AccountNumber,"");
        if (result.getCount() == 0) {
            return final_response;
        }
