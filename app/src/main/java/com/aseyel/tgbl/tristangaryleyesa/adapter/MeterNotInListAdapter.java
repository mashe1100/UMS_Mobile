...
public class MeterNotInListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    private static final String TAG = MeterNotInListAdapter.class.getSimpleName();
        ...
        mCellViewHolder.llAuditDetails.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    ...
                    Liquid.SelectedMeterNumber = ListItems.get(adapterPosition).getTitle();
                    Intent i = new Intent(view.getContext(), NewMeterNotInListActivity.class);
        ...
        mCellViewHolder.btnDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try
                {
                    int adapterPosition = mCellViewHolder.getAdapterPosition();
                    Liquid.SelectedCode = ListItems.get(adapterPosition).getId();
                    ((MeterNotInListActivity) context).DeleteData(Liquid.SelectedCode,adapterPosition);
                }
                catch(Exception e){
                    Log.e(TAG, e.toString(),e);
                }
