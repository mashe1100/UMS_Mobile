    ...
    public  BillItem[] BillItemsIleco2 =
            {
                    ...
                    new BillItem(                                                                                                           ItemStyle.Separator),
                    new BillItem("Senior Citizen Subsidy",                           String.valueOf(LiquidBilling.senior), String.valueOf(LiquidBilling.total_senior),       ItemStyle.Detail),
                    new BillItem("Inclusion",                           String.valueOf(LiquidBilling.bilp), String.valueOf(LiquidBilling.overdue),       ItemStyle.OptionalDetail),
                    new BillItem(                                                                                                           ItemStyle.Separator),
                    new BillItem("Amount Due",                        String.valueOf(LiquidBilling.total_current_bill), ItemStyle.Total),
    ...
    public  BillItem[] BillItemsBaliwagWD =
            {
                    ...
                    new BillItem("Senior Citizen Discount",              String.valueOf(LiquidBilling.senior), ItemStyle.OptionalFooter),
                    new BillItem(                                                                                                                                                              ItemStyle.Separator),
                    ...
                    new BillItem("EMF SC Discount",              String.valueOf(LiquidBilling.emf_senior), ItemStyle.OptionalFooter),
                    new BillItem(Liquid.pn_promotitle,              Liquid.pn_promo, ItemStyle.OptionalFooter),
                    new BillItem(                                                                                                                                                                      ItemStyle.Separator),
                    new BillItem("AMOUNT BEFORE DUE",                    String.valueOf(LiquidBilling.total_amount_due), ItemStyle.Total),
                    new BillItem(                                                                                          ItemStyle.Separator),
                    new BillItem("Penalty (Water Bill)",              String.valueOf(LiquidBilling.surcharge), ItemStyle.Aftertotal),
                    new BillItem("Penalty (Septage Fee)",              String.valueOf(LiquidBilling.total_other_charges), ItemStyle.Aftertotal),
                    new BillItem("AMOUNT AFTER DUE",                     String.valueOf(LiquidBilling.total_amount_due2), ItemStyle.Total),
                    new BillItem("Due Date for "+Liquid.dateChangeFormat(Liquid.BillMonth,"MM","MMM") +" "+Liquid.BillYear ,      Liquid.dateChangeFormat(Liquid.duedate,"yyyy-MM-dd","MM/dd/yyyy"), ItemStyle.Aftertotal),
                    new BillItem(                                           ItemStyle.Separator),
            };
