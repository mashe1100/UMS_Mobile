...
import com.aseyel.tgbl.tristangaryleyesa.adapter.TrackingCoolerPlanogramAdapter;
...
public class TrackingCoolerPlanogramFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    TrackingCoolerPlanogramAdapter Adapter;
    Liquid.ApiData mApiData;
    View mView;
    @BindView(R.id.rvTrackingCoolerPlanogramList)
    RecyclerView rvList;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try{
            mView = inflater.inflate(R.layout.fragment_tab_tracking_coolerplanogram, container, false);
            setup(mView);
            GetData(true,"");
        }catch(Exception e){
            Log.e(TAG,"Error :",e);
    ...
    private void setup(View view) {
        try {
            ...
            Adapter = new TrackingCoolerPlanogramAdapter(this);
            rvList = (RecyclerView) view.findViewById(R.id.rvTrackingCoolerPlanogramList);
            ...
            floatBtnComment.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Liquid.SelectedCategory = "Cooler Planogram";
            ...
            public void onClick(DialogInterface dialog, int which) {
                switch (which){
                    case DialogInterface.BUTTON_POSITIVE:
                        ...
                        result = TrackingModel.DeleteCoolerPlanogram(OutletNumber,ProductCode, Period);
    ...
    public void GetData(boolean animated,String search){
        ...
        Cursor result = TrackingModel.GetCoolerPlanogramList(search);
        try
        {
    ...
    private int GetImagesThumbnail(String value){
        ...
        switch(value){
            case "60:40":
                imageURL = R.drawable.img_coke_cooler_6040;
                break;
            case "Coke RED Cooler":
                imageURL = R.drawable.img_coke_location_commoncoldvault;
                break;
            case "MDC Cooler Rental":
